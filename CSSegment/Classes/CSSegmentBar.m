...
@property (nonatomic, strong) CSSegmentBarConfig *config;
@end

#define kMinMargin 30

@implementation CSSegmentBar

#pragma mark - interface
+ (instancetype)segmentBarWithFrame: (CGRect)frame {
    CSSegmentBar *segmentBar = [[CSSegmentBar alloc] initWithFrame:frame];
...
- (CSSegmentBarConfig *)config {
    if (!_config) {
        _config = [CSSegmentBarConfig defaultConfig];
    }
    return _config;
}

...
@interface CSSegmentBarViewController ()<CSSegmentBarDelegate, UIScrollViewDelegate>

@property (nonatomic, weak) UIScrollView *contentView;

@end

@implementation CSSegmentBarViewController

- (CSSegmentBar *)segmentBar {
    if (!_segmentBar) {
        CSSegmentBar *segmentBar = [CSSegmentBar segmentBarWithFrame:CGRectZero];
